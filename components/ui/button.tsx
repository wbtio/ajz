...
const Button = forwardRef<HTMLButtonElement, ButtonProps>(
  ({ className, variant = 'primary', size = 'md', isLoading, asChild = false, children, disabled, ...props }, ref) => {
    ...
    const variants = {
      primary: 'bg-[#8B0000] text-white hover:bg-[#6B0000] focus:ring-[#8B0000]/40 shadow-sm hover:shadow-md active:bg-[#600000]',
      secondary: 'bg-slate-100 text-slate-900 hover:bg-slate-200 focus:ring-slate-400 active:bg-slate-300',
      outline: 'border-2 border-[#8B0000] text-[#8B0000] hover:bg-[#8B0000]/5 focus:ring-[#8B0000]/40 active:bg-[#8B0000]/10',
