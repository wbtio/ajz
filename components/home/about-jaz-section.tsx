...
import {
  ...
  UsersIcon as Users,
  HeartHandshakeIcon as Handshake,
...
export function AboutJazSection() {
  ...
  const fadeLeft: Variants = {
    hidden: {
      opacity: 0,
      x: shouldReduceMotion ? 0 : isRTL ? 55 : -55,
        ...
        <div className="mx-auto max-w-6xl">
          ...
          >
            ...
            >
              ...
              <p
                className={`max-w-3xl text-start text-base text-gray-700 sm:text-lg md:text-xl ${isRTL ? "leading-[2.05]" : "leading-8"}`}
              >
            ...
            <motion.div
              ...
              className="grid grid-cols-1 gap-4 sm:gap-5 lg:col-span-5"
            >
