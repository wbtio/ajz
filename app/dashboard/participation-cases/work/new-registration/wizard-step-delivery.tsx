            ...
            <div className="grid grid-cols-1 gap-3 lg:grid-cols-[minmax(0,1fr)_300px]">
              ...
              <section className="rounded-xl border border-slate-200 bg-slate-50/60 p-4 space-y-4">
                ...
                <div className="grid grid-cols-1 gap-2">
                  ...
                  <Button type="button" variant="outline" onClick={openDeliveryEmail} disabled={!String(client?.email || searchForm.email || "").trim()} className="border-slate-300 bg-white text-slate-700 hover:border-[#8B0000]/40 hover:bg-[#8B0000]/5 hover:text-[#8B0000] gap-2">
