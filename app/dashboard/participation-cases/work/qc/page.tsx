...
export default async function QcStation() {
    ...
    if (!canAccessPath(profile?.role, '/dashboard/participation-cases/work/qc', profile?.permissions as string[] | null)) {
    ...
    const { data: cases } = await supabase
        ...
        `)
        .in('case_status', ['final_qc', 'correction_required', 'ready_for_next_stage', 'document_matching'])
