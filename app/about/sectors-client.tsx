      ...
      <Container>
        ...
        >
          ...
          <p className="text-lg lg:text-xl text-gray-600 max-w-2xl mx-auto leading-relaxed">
            We cover strategic divisions that contribute to the development of
            the Iraqi economy and provide opportunities for growth and
            networking
          </p>
        </motion.div>
        ...
        {sectors && sectors.length > 0 ? (
          ...
          >
            {sectors.map((rawSector) => {
              const sector = mergeSectorWithContent(rawSector);
              const IconComponent =
                iconMap[sector.icon || "Building2"] || Building2;
              return (
                <motion.div
                  key={sector.id}
          ...
          >
            <p className="text-gray-500 text-lg">
              No strategic divisions available at the moment
            </p>
          </motion.div>
        )}
      </Container>
