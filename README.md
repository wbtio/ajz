...
3. **أقسامنا الاستراتيجية (Our Strategic Divisions):** 
   - يضم أهم الأقسام الاستراتيجية، مع نماذج طلب مخصصة لكل قسم (`sector-registration-form`).
4. **الشركاء (Partners):**
...
* **/dashboard/home & stats:** بطاقات متحركة تعرض نسب الحجوزات ونمو النظام بصرياً بفضل مجلد `app/dashboard/_components`.
